...
+++ https://github.com/okex/exchain/ibc-3rd/cosmos-v443/blob/v0.40.0-rc3/simapp/app.go#L145-L187
...
+++ https://github.com/okex/exchain/ibc-3rd/cosmos-v443/blob/v0.40.0-rc3/server/types/app.go#L48-L50
...
+++ https://github.com/okex/exchain/ibc-3rd/cosmos-v443/blob/v0.40.0-rc3/simapp/app.go#L464-L471
...
+++ https://github.com/okex/exchain/ibc-3rd/cosmos-v443/blob/v0.40.0-rc3/simapp/app.go#L454-L462
...
+++ https://github.com/okex/exchain/ibc-3rd/cosmos-v443/blob/v0.40.0-rc3/simapp/params/encoding.go#L9-L16
...
+++ https://github.com/okex/exchain/ibc-3rd/cosmos-v443/blob/590358652cc1cbc13872ea1659187e073ea38e75/simapp/encoding.go#L8-L19
...
+++ https://github.com/okex/exchain/ibc-3rd/cosmos-v443/blob/v0.40.0-rc3/proto/cosmos/bank/v1beta1/tx.proto#L10-L17
...
- Custom request type definitions for each query or transaction creation function that needs to be exposed. These custom request types build on the base `request` type of the Cosmos SDK:
  +++ https://github.com/okex/exchain/ibc-3rd/cosmos-v443/blob/v0.40.0-rc3/types/rest/rest.go#L62-L76
...
::: warning
A patch introduced in `go-grpc v1.34.0` made gRPC incompatible with the `gogoproto` library, making some [gRPC queries](https://github.com/okex/exchain/ibc-3rd/cosmos-v443/issues/8426) panic. As such, the SDK requires that `go-grpc <=v1.33.2` is installed in your `go.mod`.
...
Please see [issue #8392](https://github.com/okex/exchain/ibc-3rd/cosmos-v443/issues/8392) for more info.
:::
