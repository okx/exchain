...
Currently, KVStore data can be remotely accessed through [Queries](https://github.com/okex/exchain/ibc-3rd/cosmos-v443/blob/master/docs/building-modules/messages-and-queries.md#queries)
