...
If you want to open a PR on the Cosmos SDK to update the documentation, please follow the guidelines in the [`CONTRIBUTING.md`](https://github.com/okex/exchain/ibc-3rd/cosmos-v443/tree/master/CONTRIBUTING.md#updating-documentation)
...
[master](https://github.com/okex/exchain/ibc-3rd/cosmos-v443/tree/master/docs).
...
Then, edit the `swagger.yaml` manually; it is found [here](https://github.com/okex/exchain/ibc-3rd/cosmos-v443/blob/master/client/lcd/swagger-ui/swagger.yaml)
