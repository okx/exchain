...
import (
	...
	types1 "github.com/okex/exchain/ibc-3rd/cosmos-v443/crypto/types"
	...
	signing "github.com/okex/exchain/ibc-3rd/cosmos-v443/types/tx/signing"
...
type TxBody struct {
	...
	// but should be called `note` instead (see https://github.com/okex/exchain/ibc-3rd/cosmos-v443/issues/9122).
...
type Fee struct {
	...
	Amount github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,1,rep,name=amount,proto3,castrepeated=github.com/okex/exchain/ibc-3rd/cosmos-v443/types.Coins" json:"amount"`
