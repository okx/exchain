...
# " [\#number](https://github.com/okex/exchain/ibc-3rd/cosmos-v443/issues/<number>)
...
for line in fileinput.input(inplace=1):
    line = re.sub(r"\s\\#([0-9]+)", r" [\\#\1](https://github.com/okex/exchain/ibc-3rd/cosmos-v443/issues/\1)", line.rstrip())
    print(line)