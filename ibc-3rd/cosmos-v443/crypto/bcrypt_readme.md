...
```bash
go test -v --bench github.com/okex/exchain/ibc-3rd/cosmos-v443/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/okex/exchain/ibc-3rd/cosmos-v443/crypto/keys/mintkey
...
PASS
ok  	github.com/okex/exchain/ibc-3rd/cosmos-v443/crypto/keys/mintkey	12.093s
```
