...
import (
	...
	"github.com/okex/exchain/ibc-3rd/cosmos-v443/x/gov/client/cli"
	gov "github.com/okex/exchain/ibc-3rd/cosmos-v443/x/gov/types"
	"github.com/okex/exchain/ibc-3rd/cosmos-v443/x/upgrade/types"
)
...
func NewCmdSubmitUpgradeProposal() *cobra.Command {
	cmd := &cobra.Command{
		...
		Long: "Submit a software upgrade along with an initial deposit.\n" +
			...
			"You may include info to reference a binary download link, in a format compatible with: https://github.com/okex/exchain/ibc-3rd/cosmos-v443/tree/master/cosmovisor",
