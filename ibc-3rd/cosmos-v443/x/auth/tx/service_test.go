...
import (
	...
	kmultisig "github.com/okex/exchain/ibc-3rd/cosmos-v443/crypto/keys/multisig"
	...
	authtest "github.com/okex/exchain/ibc-3rd/cosmos-v443/x/auth/client/testutil"
	bankcli "github.com/okex/exchain/ibc-3rd/cosmos-v443/x/bank/client/testutil"
	...
	for _, tc := range testCases {
		s.Run(tc.name, func() {
			...
			if tc.expErr {
				...
				// ref: https://github.com/okex/exchain/ibc-3rd/cosmos-v443/issues/8680
				// ref: https://github.com/okex/exchain/ibc-3rd/cosmos-v443/issues/8681
