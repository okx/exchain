...
type StakeAuthorization struct {
	...
	MaxTokens *types.Coin `protobuf:"bytes,1,opt,name=max_tokens,json=maxTokens,proto3,castrepeated=github.com/okex/exchain/ibc-3rd/cosmos-v443/types.Coin" json:"max_tokens,omitempty"`
