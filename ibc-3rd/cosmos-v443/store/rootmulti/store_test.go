...
import (
	...
	sdkmaps "github.com/okex/exchain/ibc-3rd/cosmos-v443/store/internal/maps"
...
func benchmarkMultistoreSnapshot(b *testing.B, stores uint8, storeKeys uint64) {
	b.Skip("Noisy with slow setup time, please see https://github.com/okex/exchain/ibc-3rd/cosmos-v443/issues/8855.")
