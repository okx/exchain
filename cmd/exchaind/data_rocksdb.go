...
// ldbToRdb convert goleveldb to rocksdb
func ldbToRdb(name, fromDir, toDir string) {
...
// rdbtoBdb convert rocksdb to badgerdb
func rdbtoBdb(name, fromDir, toDir string) {
