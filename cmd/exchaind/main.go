...
func main() {
	...
	executor := cli.PrepareBaseCmd(rootCmd, "EXCHAIN", app.DefaultNodeHome)
...
func exportAppStateAndTMValidators(
	...
	var ethermintApp *app.ExChainApp
	if height != -1 {
		ethermintApp = app.NewExChainApp(logger, db, traceStore, false, map[int64]bool{}, 0)

		if err := ethermintApp.LoadHeight(height); err != nil {
			return nil, nil, err
		} else {
			ethermintApp = app.NewExChainApp(logger, db, traceStore, true, map[int64]bool{}, 0)
		}
	}
