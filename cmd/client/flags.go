...
func RegisterAppFlag(cmd *cobra.Command) {
	...
	cmd.Flags().String(tmdb.FlagRocksdbOpts, "unordered_write=true", "Options of rocksdb. (block_size=4KB,block_cache=1GB,statistics=true,allow_mmap_reads=true,max_open_files=-1)")
