...
func RegisterAppFlag(cmd *cobra.Command) {
	...
	cmd.Flags().String(app.Elapsed, "Evm=0,Iavl=0,DeliverTxs=0,Round=0,CommitRound=0,Produce=0", "Evm=x,Iavl=x,DeliverTxs=x,Round=x,CommitRound=x,Produce=x x is 1 or 0")
