...
func ExportEthCompCommand() *cobra.Command {
	return &cobra.Command{
		...
		Short:  "Export an Ethereum private keystore directory (This command has been deprecated,please use 'exchaincli keys export-eth-comp')",
		Hidden: true,
	...
	The parameters of scrypt encryption algorithm is StandardScryptN and StandardScryptN`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return fmt.Errorf("This command has been deprecated,please use 'exchaincli keys export-eth-comp'")
		},
	}
}
