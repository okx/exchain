...
//	err = handler(newCtx, storedProposal.Content)
//	require.NoError(t, err)
//
//	// then
...
//
//	// check balance
//	bal := bankKeeper.GetCoins(ctx, contractAddr)
//	require.Equal(t, bal.AmountOf("denom"), sdk.NewInt(100))
//
//	releaseMsg := struct {
...
//	bal = bankKeeper.GetCoins(ctx, contractAddr)
//	require.Equal(t, bal.AmountOf("denom"), sdk.NewInt(0))
//}
//
...
//	bal := bankKeeper.GetCoins(ctx, contractAddr)
//	require.Equal(t, bal.AmountOf("denom"), sdk.NewInt(100))
//	bal = bankKeeper.GetCoins(ctx, anyAddr)
//	require.Equal(t, bal.AmountOf("denom"), sdk.NewInt(0))
//
...
//	bal = bankKeeper.GetCoins(ctx, contractAddr)
//	require.Equal(t, bal.AmountOf("denom"), sdk.NewInt(25))
//	bal = bankKeeper.GetCoins(ctx, anyAddr)
//	require.Equal(t, bal.AmountOf("denom"), sdk.NewInt(75))
//}
//
...
//				Value:    string(cdc.GetCdc().MustMarshalJSON(&types.AllowNobody)),
//			},
...
//				Subspace: types.ModuleName,
//				Key:      string(types.ParamStoreKeyUploadAccess),
//				Value:    string(cdc.GetCdc().MustMarshalJSON(&oneAddressAccessConfig)),
//			},
...
//				ParameterChangeProposal: params2.ParameterChangeProposal{
//					Title:       "Foo",
//					Description: "Bar",
