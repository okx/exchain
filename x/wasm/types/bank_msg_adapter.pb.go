...
type MsgSend struct {
	...
	Amount      github_com_cosmos_cosmos_sdk_types.CoinAdapters `protobuf:"bytes,3,rep,name=amount,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"amount"`
}
...
func (c *msgBankClient) Send(ctx context.Context, in *MsgSend, opts ...grpc.CallOption) (*MsgSendResponse, error) {
...
func RegisterBankMsgServer(s grpc1.Server, srv MsgBankServer) {
...
func _Msg_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgBankServer).Send(ctx, req.(*MsgSend))
	}
...
func (m *MsgSend) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Amount = append(m.Amount, github_com_cosmos_cosmos_sdk_types.CoinAdapter{})
