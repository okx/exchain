...
Example:
$ %s query staking validator exchainvaloper1alq9na49n9yycysh889rl90g9nhe58lcqkfpfg
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query staking shares-added-to exchainvaloper1alq9na49n9yycysh889rl90g9nhe58lcqkfpfg
`,
				version.ClientName,
			),
		),
