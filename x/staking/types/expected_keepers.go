...
type SupplyKeeper interface {
	...
	SendCoinsFromModuleToModule(ctx sdk.Context, senderPool, recipientPool string, amt sdk.SysCoins) sdk.Error
	...
	BurnCoins(ctx sdk.Context, name string, amt sdk.SysCoins) sdk.Error
}
