563233095 A:167524064334600} Validator{E6F10F611145D6D7AB4521FCD35BEA6C61957112 PubKeyEd25519{002F3B10A4574B5DAF493345572D40722765DC4975F4D2C51A76760162180852} VP:74818442389266 A:9630202784619} Validator{ED7AFF397240437610647C42D7D821DF0592B6FE PubKeyEd25519{2E72DE978321876A95F5B8247D98F1257D478BFA5BEDF5D7520F8A1C8782F07C} VP:74818442389266 A:9738676752058} Validator{FCBECF9CA3CCC502E999186A25DD49CB7FBF3EE5 PubKeyEd25519{29B4789D5CC9EA66C29AD2F709A476551ED138DEE11C562C8F1E8031E093A3B2} VP:74818442389266 A:-27649254063536}]\" stack=\"goroutine 199 [running]:\nruntime/debug.Stack(0x0, 0x0, 0x0)\n\t/usr/local/go/src/runtime/debug/stack.go:24 +0xa1\ngithub.com/tendermint/tendermint/consensus.(*State).receiveRoutine.func2(0xc001701500, 0x2537a28)\n\t/root/golang/pkg/mod/github.com/okex/tendermint@v0.33.9-okexchain6/consensus/state.go:630 +0x63\npanic(0x1feb440, 0xc00414fea0)\n\t/usr/local/go/src/runtime/panic.go:975 +0x41b\ngithub.com/tendermint/tendermint/state.getBeginBlockValidatorInfo(0xc005de41c0, 0x28ed6c0, 0xc0000104d8, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, ...)\n\t/root/golang/pkg/mod/github.com/okex/tendermint@v0.33.9-okexchain6/state/execution.go:334 +0xcc7\ngithub.com/tendermint/tendermint/state.execBlockOnProxyApp(0x28d1900, 0xc000e2aa60, 0x28e1840, 0xc001a30830, 0xc005de41c0, 0x28ed6c0, 0xc0000104d8, 0x0, 0x0, 0x0)\n\t/root/golang/pkg/mod/github.com/okex/tendermint@v0.33.9-okexchain6/state/execution.go:281 +0x27f\ngithub.com/tendermint/tendermint/state.(*BlockExecutor).ApplyBlock(0xc0045df110, 0xa, 0x0, 0xc002fa2990, 0x6, 0xc002fa29b0, 0xc, 0x15e477, 0xc001f3b200, 0x20, ...)\n\t/root/golang/pkg/mod/github.com/okex/tendermint@v0.33.9-okexchain6/state/execution.go:136 +0x2b3\ngithub.com/tendermint/tendermint/consensus.(*State).finalizeCommit(0xc001701500, 0x15e478)\n\t/root/golang/pkg/mod/github.com/okex/tendermint@v0.33.9-okexchain6/consensus/state.go:1497 +0xf90\ngithub.com/tendermint/tendermint/consensus.(*State).tryFinalizeCommit(0xc001701500, 0x15e478)\n\t/root/golang/pkg/mod/github.com/okex/tendermint@v0.33.9-okexchain6/consensus/state.go:1410 +0x441\ngithub.com/tendermint/tendermint/consensus.(*State).enterCommit.func1(0xc001701500, 0x0, 0x15e478)\n\t/root/golang/pkg/mod/github.com/okex/tendermint@v0.33.9-okexchain6/consensus/state.go:1345 +0xd7\ngithub.com/tendermint/tendermint/consensus.(*State).enterCommit(0xc001701500, 0x15e478, 0x0)\n\t/root/golang/pkg/mod/github.com/okex/tendermint@v0.33.9-okexchain6/consensus/state.go:1382 +0xb67\ngithub.com/tendermint/tendermint/consensus.(*State).addVote(0xc001701500, 0xc00442d180, 0x0, 0x0, 0x53b201, 0x0, 0x0)\n\t/root/golang/pkg/mod/github.com/okex/tendermint@v0.33.9-okexchain6/consensus/state.go:1937 +0x233c\ngithub.com/tendermint/tendermint/consensus.(*State).tryAddVote(0xc001701500, 0xc00442d180, 0x0, 0x0, 0xc001fed900, 0x0, 0x0)\n\t/root/golang/pkg/mod/github.com/okex/tendermint@v0.33.9-okexchain6/consensus/state.go:1752 +0x88\ngithub.com/tendermint/tendermint/consensus.(*State).handleMsg(0xc001701500, 0x28a1d80, 0xc005670368, 0x0, 0x0)\n\t/root/golang/pkg/mod/github.com/okex/tendermint@v0.33.9-okexchain6/consensus/state.go:726 +0x915\ngithub.com/tendermint/tendermint/consensus.(*State).receiveRoutine(0xc001701500, 0x0)\n\t/root/golang/pkg/mod/github.com/okex/tendermint@v0.33.9-okexchain6/consensus/state.go:677 +0x879\ncreated by github.com/tendermint/tendermint/consensus.(*State).OnStart\n\t/root/golang/pkg/mod/github.com/okex/tendermint@v0.33.9-okexchain6/consensus/state.go:348 +0x846")
}
