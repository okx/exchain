...
func TestBigInt(t *testing.T) {
	src := []byte{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05}
	log.Printf("%v\n", big.NewInt(0).SetBytes(src).Uint64())
	t.Log(big.NewInt(0).SetBytes(src).Uint64())

	//	src = []byte{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1c, 0x96, 0x94, 0xdd, 0x7e, 0x27, 0x03, 0xf0, 0x00, 0x00}
	src = []byte{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x94, 0xdd, 0x7e, 0x27, 0x03, 0xf0, 0x00, 0x00}
	log.Printf("%v\n", big.NewInt(0).SetBytes(src).Uint64())
	//10726868593501274112
	//135004000000000000000000
	//1.35004e+23
}
