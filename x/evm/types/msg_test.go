...
import (
	...
	ibctxdecode "github.com/okex/exchain/libs/cosmos-sdk/x/auth/protobuf-tx"
...
func TestMsgIBCTxValidate(t *testing.T) {
	...
	decode := ibctxdecode.ProtoBufTxDecoder(marshaler)
	var err error
...
func TestMsgIbcTxMarshalSignBytes(t *testing.T) {
	...
	signBytes := authtypes.PbDirectSignBytes(
		chainID,
		uint64(accnum),
		uint64(sequence),
		fee,
