...
func NewKeeper(
	cdc *codec.Codec, storeKey sdk.StoreKey, paramSpace params.Subspace, ak types.AccountKeeper, sk types.SupplyKeeper, bk types.BankKeeper, iscacheOn bool,
) *Keeper {
	...
	k := &Keeper{
		...
		Cache:          types.NewCache(5000, iscacheOn),
	}
