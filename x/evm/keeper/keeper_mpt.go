...
func (k *Keeper) CommitSnapshot(root ethcmn.Hash) {
	...
	if k.EvmStateDb.Snap != nil {
		// Only update if there's a state transition (skip empty Clique blocks)
		if parent := k.EvmStateDb.Snap.Root(); parent != root {
		...
		k.EvmStateDb.Snap, k.EvmStateDb.SnapDestructs, k.EvmStateDb.SnapAccounts, k.EvmStateDb.SnapStorage = nil, nil, nil, nil
	}
}
