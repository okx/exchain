...
func (k Keeper) SetContractDeploymentWhitelistMember(ctx sdk.Context, deployerAddr ethcmn.Address) {
...
func (k Keeper) DeleteContractDeploymentWhitelistMember(ctx sdk.Context, deployerAddr ethcmn.Address) {
	ctx.KVStore(k.storeKey).Delete(types.GetContractDeploymentWhitelistMemberKey(deployerAddr))
}

func (k Keeper) isDeployerInWhiteList(ctx sdk.Context, deployerAddr ethcmn.Address) bool {
