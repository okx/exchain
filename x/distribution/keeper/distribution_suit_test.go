...
func TestFirstOnline(t *testing.T) {
	...
	_, err = dk.WithdrawDelegationRewards(ctx, delAddr2, valOpAddr1)
	require.NotNil(t, err)
	...
	setTestFees(t, ctx, dk, ak, blockRewardValueTokens)
	dk.AllocateTokens(ctx, 1, valConsAddr1, votes)
	_, err = dk.WithdrawDelegationRewards(ctx, delAddr3, valOpAddr1)
	require.NotNil(t, err)
	...
	setTestFees(t, ctx, dk, ak, blockRewardValueTokens)
	dk.AllocateTokens(ctx, 1, valConsAddr1, votes)
	_, err = dk.WithdrawDelegationRewards(ctx, delAddr4, valOpAddr1)
	require.NotNil(t, err)
	//check offchain type
	...
	doEditValidator(t, ctx, sk, valOpAddr1, &newCommissionRate)
	...
	_, err = dk.WithdrawDelegationRewards(ctx, delAddr1, valOpAddr1)
	require.NotNil(t, err)
	_, err = dk.WithdrawDelegationRewards(ctx, delAddr1, valOpAddr2)
	require.NotNil(t, err)
	_, err = dk.WithdrawDelegationRewards(ctx, delAddr1, valOpAddr3)
	require.NotNil(t, err)
	_, err = dk.WithdrawDelegationRewards(ctx, delAddr1, valOpAddr4)
	require.NotNil(t, err)

	//del2 withdraw
	_, err = dk.WithdrawDelegationRewards(ctx, delAddr2, valOpAddr1)
	require.NotNil(t, err)
	_, err = dk.WithdrawDelegationRewards(ctx, delAddr2, valOpAddr2)
	require.NotNil(t, err)
	_, err = dk.WithdrawDelegationRewards(ctx, delAddr2, valOpAddr3)
	require.NotNil(t, err)
	_, err = dk.WithdrawDelegationRewards(ctx, delAddr2, valOpAddr4)
	require.NotNil(t, err)

	//del3 withdraw
	_, err = dk.WithdrawDelegationRewards(ctx, delAddr3, valOpAddr1)
	require.NotNil(t, err)
	_, err = dk.WithdrawDelegationRewards(ctx, delAddr3, valOpAddr2)
	require.NotNil(t, err)
	_, err = dk.WithdrawDelegationRewards(ctx, delAddr3, valOpAddr3)
	require.NotNil(t, err)
	_, err = dk.WithdrawDelegationRewards(ctx, delAddr3, valOpAddr4)
	require.NotNil(t, err)

	//del4 withdraw
	_, err = dk.WithdrawDelegationRewards(ctx, delAddr4, valOpAddr1)
	require.NotNil(t, err)
	_, err = dk.WithdrawDelegationRewards(ctx, delAddr4, valOpAddr2)
	require.NotNil(t, err)
	_, err = dk.WithdrawDelegationRewards(ctx, delAddr4, valOpAddr3)
	require.NotNil(t, err)
	_, err = dk.WithdrawDelegationRewards(ctx, delAddr4, valOpAddr4)
	require.NotNil(t, err)
	...
	//del2 unbind
	doUnBindProxy(t, ctx, sk, delAddr2)
	...
	commission1 := dk.GetValidatorAccumulatedCommission(ctx, valOpAddr1)
	commission2 := dk.GetValidatorAccumulatedCommission(ctx, valOpAddr2)
	commission3 := dk.GetValidatorAccumulatedCommission(ctx, valOpAddr3)
	commission4 := dk.GetValidatorAccumulatedCommission(ctx, valOpAddr4)
	community := dk.GetFeePoolCommunityCoins(ctx)

	mulCount, _ := sdk.NewDecFromStr("10")
