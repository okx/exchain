...
type GenesisState struct {
	...
	FaucetCap sdk.Dec `json:"faucet_cap" yaml:"faucet_cap"`
	// max amount per request (i.e sum of all requested coin amounts).
	MaxAmountPerRequest sdk.Dec `json:"max_amount_per_request" yaml:"max_amount_per_request"`
}
...
func DefaultGenesisState() GenesisState {
	return GenesisState{
		...
		FaucetCap:           sdk.NewDec(1000000000),
		MaxAmountPerRequest: sdk.NewDec(1000),
	}
}
