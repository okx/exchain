...
res=$(exchaincli tx wasm instantiate "$code_id" '{"arbiter":"0xbbE4733d85bc2b90682147779DA49caB38C0aA1F","end_height":100000,"recipient":"0x2Bd4AF0C1D0c2930fEE852D07bB9dE87D8C07044"}' --label test1 --admin ex1h0j8x0v9hs4eq6ppgamemfyu4vuvp2sl0q9p3v --fees 0.001okt --from captain -b block -y)
