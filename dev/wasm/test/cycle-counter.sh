...
exchaincli tx wasm execute ${contract_addr} '{"increment":{"count":"1000"}}' --from captain --fees 0.01okt --gas 30000000 -y -b block | jq -r '.gas_used'
exchaincli tx wasm execute ${contract_addr} '{"increment":{"count":"10000"}}' --from captain --fees 0.01okt --gas 30000000 -y -b block | jq -r '.gas_used'
exchaincli tx wasm execute ${contract_addr} '{"increment":{"count":"100000"}}' --from captain --fees 0.01okt --gas 30000000 -y -b block | jq -r '.gas_used'
exchaincli tx wasm execute ${contract_addr} '{"increment":{"count":"1000000"}}' --from captain --fees 0.01okt --gas 30000000 -y -b block | jq -r '.gas_used'
exchaincli tx wasm execute ${contract_addr} '{"increment":{"count":"10000000"}}' --from captain --fees 0.01okt --gas 30000000 -y -b block | jq -r '.gas_used'
exchaincli tx wasm execute ${contract_addr} '{"increment":{"count":"100000000"}}' --from captain --fees 0.01okt --gas 30000000 -y -b block | jq -r '.gas_used'
