...
exchaincli keys add  captain -m "puzzle glide follow cruel say burst deliver wild tragic galaxy lumber offer" --output json > ${HOME_SERVER}/validator_seed.json 2>&1
