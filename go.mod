...
replace (
	...
	github.com/tendermint/iavl => github.com/okex/iavl v0.14.4-0.20211008041925-3d60d3fd42ca
	github.com/tendermint/tendermint => github.com/okex/tendermint v0.33.9-okexchain6.0.20211008092240-b207385583ab
