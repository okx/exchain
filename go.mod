...
require (
	...
	github.com/google/gops v0.3.12 // indirectgit add
...
replace (
	github.com/cosmos/cosmos-sdk => github.com/okex/cosmos-sdk v0.37.9-okexchain4.0.20201102084128-9dbb2a10a42c
