...
replace (
	...
	github.com/tendermint/iavl => github.com/okex/iavl v0.14.4-0.20210910064826-1eb8eeabc5fd
	github.com/tendermint/tendermint => github.com/okex/tendermint v0.33.9-okexchain6.0.20210910051056-2366d7d08aaa
