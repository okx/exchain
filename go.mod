...
replace (
	...
	github.com/tendermint/go-amino => github.com/okex/go-amino v0.15.1-okc1
	github.com/cosmos/gorocksdb => github.com/tecbot/gorocksdb v0.0.0-20191217155057-f0fad39f321c
)
