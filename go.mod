...
replace (
	...
	github.com/tendermint/iavl => github.com/okex/iavl v0.14.4-0.20211008152340-7d432d871dea
	github.com/tendermint/tendermint => github.com/okex/tendermint v0.33.9-okexchain6.0.20211008100409-3413e726cfc4
