...
replace (
	...
	github.com/tendermint/iavl => github.com/okex/iavl v0.14.4-0.20210908031840-a4fa7113addf
	github.com/tendermint/tendermint => github.com/okex/tendermint v0.33.9-okexchain6.0.20210907131300-1e6fd48aac12
