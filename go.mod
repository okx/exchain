...
replace (
	...
	github.com/tendermint/go-amino => github.com/okex/go-amino v0.15.2-0.20220118132550-2e2738a802e4
	github.com/tendermint/tm-db => github.com/okex/tm-db v0.5.3-0.20220119092729-d4d0235e1078
)
