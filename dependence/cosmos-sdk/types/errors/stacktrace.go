...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/okex/exchain/dependence/cosmos-sdk/types/errors.Wrap",
		"github.com/okex/exchain/dependence/cosmos-sdk/types/errors.Wrapf",
		"github.com/okex/exchain/dependence/cosmos-sdk/types/errors.WithType",
