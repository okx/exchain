...
rm -rf multi_run.log_123
make mainnet
cp /Users/oker/scf/bin/exchaind /Users/oker/scf/bin/exchaind_123 
chmod +x /Users/oker/scf/bin/exchaind_123
export EXCHAIND_PATH=~/.exchaind_123

#rm -rf ${EXCHAIND_PATH}
#exchaind_123 init multi_run --chain-id exchain-66 --home ${EXCHAIND_PATH}
...
exchaind_123 start --chain-id exchain-66 --mempool.sort_tx_by_gp --home ${EXCHAIND_PATH} --p2p.seeds $EXCHAIN_SEEDS > multi_run.log_123 2>&1 &
