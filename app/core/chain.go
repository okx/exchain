...
// transactions. There should only be a single implementation in OKBChain. For
// the purposes of OKBChain, it should be support retrieving headers and
// consensus parameters from  the current blockchain to be used during
// transaction processing.
//
// NOTE: OKBChain will distribute the fees out to validators, so the structure
