...
import (
	...
	paramsante "github.com/okex/exchain/x/params/ante"
...
func NewAnteHandler(ak auth.AccountKeeper, evmKeeper EVMKeeper, sk types.SupplyKeeper, validateMsgHandler ValidateMsgHandler, option wasmkeeper.HandlerOption, ibcChannelKeepr *ibc.Keeper, paramsKeeper params.Keeper) sdk.AnteHandler {
	...
	stdTxAnteHandler = sdk.ChainAnteDecorators(
		...
		paramsante.NewAnteDecorator(paramsKeeper),
	)
