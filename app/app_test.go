...
func TestOKChainApp_MountKVStores(t *testing.T) {
	...
	m := make(map[string]*sdk.KVStoreKey, 0)
...
func makeTestTx(t *testing.T) auth.StdTx {
	...
	orderMsg := order.NewMsgNewOrder(addr, common.TestTokenPair, common.BuyOrder, "1", "0.1")
