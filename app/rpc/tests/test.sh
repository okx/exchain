...
exchaind add-genesis-account $(exchaincli keys show $KEY1 -a --home $HOME_CLI) 1000000000okb --home $HOME_SERVER
exchaind add-genesis-account $(exchaincli keys show $KEY2 -a --home $HOME_CLI) 1000000000okb --home $HOME_SERVER
