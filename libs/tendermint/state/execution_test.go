...
func TestApplyBlock(t *testing.T) {
	...
	_, retainHeight, _, err := blockExec.ApplyBlock(state, blockID, block, nil)
	require.Nil(t, err)
...
func TestEndBlockValidatorUpdates(t *testing.T) {
	...
	state, _, _, err = blockExec.ApplyBlock(state, blockID, block, nil)
	require.Nil(t, err)
...
func TestEndBlockValidatorUpdatesResultingInEmptySet(t *testing.T) {
	...
	assert.NotPanics(t, func() { state, _, _, err = blockExec.ApplyBlock(state, blockID, block, nil) })
	assert.NotNil(t, err)
