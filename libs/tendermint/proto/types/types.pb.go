...
import (
	...
	merkle "github.com/okex/exchain/libs/tendermint/proto/crypto/merkle"
	bits "github.com/okex/exchain/libs/tendermint/proto/libs/bits"
	version "github.com/okex/exchain/libs/tendermint/proto/version"
	"io"
	math "math"
	math_bits "math/bits"
	time "time"
...
type BlockID struct {
	...
	PartsHeader          PartSetHeader `protobuf:"bytes,2,opt,name=parts_header,json=part_set_header,proto3" json:"part_set_header"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
