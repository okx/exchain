...
type RequestBeginBlock struct {
	...
	UseDeltas            bool           `protobuf:"varint,5,opt,name=use_deltas,json=useDeltas,proto3" json:"use_deltas,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
}
...
func (m *RequestBeginBlock) GetUseDeltas() bool {
	if m != nil {
		return m.UseDeltas
	}
	return false
...
type Deltas struct {
	AbciRsp              []byte   `protobuf:"bytes,1,opt,name=abci_rsp,json=abciRsp,proto3" json:"abci_rsp,omitempty"`
	DeltasByte           []byte   `protobuf:"bytes,2,opt,name=deltas_byte,json=deltasByte,proto3" json:"deltas_byte,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Deltas) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Deltas.Merge(m, src)
}
...
func (m *Deltas) GetDeltasByte() []byte {
	if m != nil {
		return m.DeltasByte
	}
	return nil
...
func (m *RequestCommit) GetDeltas() *Deltas {
	if m != nil {
		return m.Deltas
	}
	return nil
...
func (m *ResponseCommit) GetDeltas() *Deltas {
	if m != nil {
		return m.Deltas
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*Deltas)(nil), "tendermint.abci.types.Deltas")
	golang_proto.RegisterType((*Deltas)(nil), "tendermint.abci.types.Deltas")
...
func (this *RequestBeginBlock) Equal(that interface{}) bool {
	...
	if this.UseDeltas != that1.UseDeltas {
		return false
	}
	if !bytes.Equal(this.XXX_unrecognized, that1.XXX_unrecognized) {
		return false
...
func (this *Deltas) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*Deltas)
	if !ok {
		that2, ok := that.(Deltas)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !bytes.Equal(this.AbciRsp, that1.AbciRsp) {
		return false
	}
	if !bytes.Equal(this.DeltasByte, that1.DeltasByte) {
		return false
	}
	if !bytes.Equal(this.XXX_unrecognized, that1.XXX_unrecognized) {
		return false
...
func (this *RequestCommit) Equal(that interface{}) bool {
	...
	if !this.Deltas.Equal(that1.Deltas) {
		return false
	}
	if !bytes.Equal(this.XXX_unrecognized, that1.XXX_unrecognized) {
		return false
...
func (m *Deltas) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.DeltasByte) > 0 {
		i -= len(m.DeltasByte)
		copy(dAtA[i:], m.DeltasByte)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.DeltasByte)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.AbciRsp) > 0 {
		i -= len(m.AbciRsp)
		copy(dAtA[i:], m.AbciRsp)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.AbciRsp)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *RequestCommit) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Deltas != nil {
		{
			size, err := m.Deltas.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func NewPopulatedRequestBeginBlock(r randyTypes, easy bool) *RequestBeginBlock {
	...
	this.UseDeltas = bool(bool(r.Intn(2) == 0))
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedTypes(r, 6)
	}
	return this
...
func NewPopulatedDeltas(r randyTypes, easy bool) *Deltas {
	this := &Deltas{}
	v13 := r.Intn(100)
	this.AbciRsp = make([]byte, v13)
	for i := 0; i < v13; i++ {
		this.AbciRsp[i] = byte(r.Intn(256))
	}
	v14 := r.Intn(100)
	this.DeltasByte = make([]byte, v14)
	for i := 0; i < v14; i++ {
		this.DeltasByte[i] = byte(r.Intn(256))
	}
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedTypes(r, 3)
	}
...
func NewPopulatedRequestCommit(r randyTypes, easy bool) *RequestCommit {
	this := &RequestCommit{}
	if r.Intn(5) != 0 {
		this.Deltas = NewPopulatedDeltas(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedTypes(r, 2)
	}
...
func (m *RequestBeginBlock) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field UseDeltas", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *Deltas) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AbciRsp", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AbciRsp = append(m.AbciRsp[:0], dAtA[iNdEx:postIndex]...)
			if m.AbciRsp == nil {
				m.AbciRsp = []byte{}
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DeltasByte", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DeltasByte = append(m.DeltasByte[:0], dAtA[iNdEx:postIndex]...)
			if m.DeltasByte == nil {
				m.DeltasByte = []byte{}
			}
			iNdEx = postIndex
...
func (m *RequestCommit) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := m.Deltas.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
