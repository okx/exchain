...
func (app *PersistentKVStoreApplication) DeliverTxs(txs []types.RequestDeliverTx, stopFunc func(int) bool) []types.ResponseDeliverTx {
	ret := make([]types.ResponseDeliverTx, len(txs))
	for i, tx := range txs {
