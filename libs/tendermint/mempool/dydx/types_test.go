...
func TestSign(t *testing.T) {
	orderBytes, err := hex.DecodeString("")
	require.NoError(t, err)

	orderHash := common.FromHex("0xca0af17797fcfa10e87526529280c40f5b8e1b5f371123d33310eb2374147fdd")
	...
	orderBytes = append(orderBytes, data...)
	orderBytes = append(orderBytes, 1)

	orderBytes, err = hex.DecodeString("")
	require.NoError(t, err)

	var wrapOdr WrapOrder
	err = wrapOdr.DecodeFrom(orderBytes)
	require.NoError(t, err)
