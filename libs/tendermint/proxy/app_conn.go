...
type AppConnConsensus interface {
	...
	PreDeliverRealTxAsync(req types.RequestDeliverTx) types.TxEssentials
...
func (app *appConnConsensus) PreDeliverRealTxAsync(req types.RequestDeliverTx) types.TxEssentials {
