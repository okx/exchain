...
func TestRedisClient_SetGetDistState(t *testing.T) {
...
func TestRedisClient_FetchReleaseDistLock(t *testing.T) {
	ss, err := getRedisClient()
	require.Nil(t, err)
...
func TestRedisClient_UnlockDistLockWithState(t *testing.T) {
	ss, err := getRedisClient()
	require.Nil(t, err)
