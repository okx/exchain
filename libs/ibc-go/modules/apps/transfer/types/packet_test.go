...
func TestFungibleTokenPacketDataValidateBasic(t *testing.T) {
	testCases := []struct {
		...
		{"valid packet with large amount", NewFungibleTokenPacketData(denom, largeAmount, addr1.String(), addr2), true},
		{"invalid denom", NewFungibleTokenPacketData("", amount, addr1.String(), addr2), false},
		{"invalid empty amount", NewFungibleTokenPacketData(denom, "", addr1.String(), addr2), false},
		{"invalid zero amount", NewFungibleTokenPacketData(denom, "0", addr1.String(), addr2), false},
		{"invalid negative amount", NewFungibleTokenPacketData(denom, "-1", addr1.String(), addr2), false},
		{"invalid large amount", NewFungibleTokenPacketData(denom, invalidLargeAmount, addr1.String(), addr2), false},
