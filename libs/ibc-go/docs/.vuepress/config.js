module.exports = {
  ...
  themeConfig: {
    repo: "okex/exchain/libs/ibc-go",
    docsRepo: "okex/exchain/libs/ibc-go",
    docsDir: "docs",
    editLinks: true,
    label: "ibc",
    // TODO
          ...
          children: [
            {
              ...
              url:
                "https://github.com/okex/exchain/libs/ibc-go/blob/main/docs/DOCS_README.md"
            },
            {
              title: "Source code on GitHub",
              url: "https://github.com/okex/exchain/libs/ibc-go/"
            }
          ]
        }
      ]
