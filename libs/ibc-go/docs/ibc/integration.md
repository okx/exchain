...
module](https://github.com/okex/exchain/libs/ibc-go/tree/main/modules/core) to your Cosmos SDK application and
...
by the port
[`Router`](https://github.com/okex/exchain/libs/ibc-go/blob/main/modules/core/05-port/types/router.go) on the
IBC module.
...
[`BeginBlock`](https://github.com/okex/exchain/libs/ibc-go/blob/main/modules/core/02-client/abci.go) logic as
...
[`SimApp`](https://github.com/okex/exchain/libs/ibc-go/blob/main/testing/simapp/app.go).
