...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/okx/exchain/libs/cosmos-sdk/types/errors.Wrap",
		"github.com/okx/exchain/libs/cosmos-sdk/types/errors.Wrapf",
		"github.com/okx/exchain/libs/cosmos-sdk/types/errors.WithType",
