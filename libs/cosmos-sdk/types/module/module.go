...
//func (m *Manager) CollectUpgradeModules() (map[int64]*HeightTasks, types.HeightFilterPipeline, map[string]params.ParamSet) {
...
//			if set != nil {
//				if p, exist := paramsRet[ada.ModuleName()]; exist {
//					paramsRet[ada.ModuleName()] = p
//				}
//			}
//			h := ada.UpgradeHeight()
//			if h <= 0 {
