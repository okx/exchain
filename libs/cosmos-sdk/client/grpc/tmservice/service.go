...
func validatorsOutput(ctx context.Context, cctx cliContext.CLIContext, height *int64, page, limit int) (*GetLatestValidatorSetResponse, error) {
	vs, err := rpc.GetValidators(cctx, height, page, limit)
	if err != nil {
		return nil, err
	}
