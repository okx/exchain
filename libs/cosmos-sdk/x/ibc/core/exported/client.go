...
type ClientState interface {
	...
	Initialize(sdk.Context, codec.Codec, sdk.KVStore, ConsensusState) error
	...
	CheckMisbehaviourAndUpdateState(sdk.Context, codec.Codec, sdk.KVStore, Misbehaviour) (ClientState, error)
	CheckProposedHeaderAndUpdateState(sdk.Context,codec.Codec, sdk.KVStore, Header) (ClientState, ConsensusState, error)
