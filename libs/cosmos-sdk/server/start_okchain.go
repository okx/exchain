...
func RegisterServerFlags(cmd *cobra.Command) *cobra.Command {
	...
	cmd.Flags().Float64(tmiavl.FlagIavlCacheInitRatio, 0.5, "iavl cache init ratio, 0.0~1.0, default is 0, iavl cache map would be init with (cache size * init ratio)")
