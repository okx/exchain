...
func (tree *MutableTree) DeleteVersionsRange(fromVersion, toVersion int64, ignore ...bool) error {
	batch := tree.NewBatch()
	if err := tree.ndb.DeleteVersionsRange(batch, fromVersion, toVersion, ignore...); err != nil {
		return err
	}
